# -*- coding: utf-8 -*-
"""master_mlmd_force.ipynb

Automatically generated by Colaboratory.

Original file is located at
    https://colab.research.google.com/drive/1wFBg1FydYGBKkr_0_kJosWB6XGUpyMo4
"""
...
## load scaled data
dict_scl = np.load('data_force_scl.npy', allow_pickle=True)
...
np.save('model_force_info.npy',np.array([dict_info]))
...
axs[1].plot(dataou_tr,dataes_tr,'*',markersize = 1, label = 'output data');
...
axs[2].plot(dataou_te,dataes_te,'*',markersize = 1, label = 'output data');
...
filename = 'force_trainin_testing_plots.png'
